...
const struct Component::key_value Component::kMarkerMap[] = {
  ...
  { Component::scRNNComponent, "<RNNComponent>"}
};
...
Component* Component::NewComponentOfType(ComponentType comp_type,
  ...
  switch (comp_type) {
    ...
    case Component::kMultiBasisComponent :
      ...
      break;
	// new TCN Component
    case Component::scTCNComponent :
      ans = new TCNComponent(input_dim, output_dim);
      break;
    ...
    case Component::scTCN3WayProjectionComponent :
      ...
      break;
    // new RNN Component
    case Component::scRNNComponent :
      ans = new RNNComponent(input_dim, output_dim);
      break;
