...
#cp /home/queen/kaldi/cusent/CUSENT/list/BaseSyl_no_sp.dict $dir/lexicon.txt
#cp /home/queen/kaldi/cusent/CUSENT/list/IF.list $dir/phones.txt
cp /media/datasets/CUSENT_wav_copy/list/cantonese_phone/word_table.dict $dir/lexicon.txt
cp /media/datasets/CUSENT_wav_copy/list/cantonese_phone/phone.list $dir/phones.txt
...
#cp /home/verna/kaldi-trunk/egs/cusent/CUSENT/list/syl_unigram.arpa $lm/
cp /media/datasets/CUSENT_wav_copy/list/lm_trigram.arpa $lm/
#local/arpa2fst.sh $lm syl_unigram.arpa
#local/arpa2fst.sh $lm syl_bigram.arpa
