...
echo ">> Prepare data & dictionary & language model"
 ...
 CUSENT=/home/queen/kaldi/cusent/CUSENT/CUSENT_wav_copy
...
# echo ">> Train mono phone GMM-HMM "
 ...
 # echo ">> Decode"
# # #utils/mkgraph.sh --mono data/local/lm/fst/bigram.arpa exp/mono exp/mono/graph
# # utils/mkgraph.sh --mono data/local/lm/fst/train_lm_e_bi.arpa exp/mono exp/mono/graph
# utils/mkgraph.sh --mono data/local/lm/fst/train_e_bi_new.arpa exp/mono exp/mono/graph
...
# # # utils/mkgraph.sh data/local/lm/fst/train_lm_e_bi.arpa exp/tri1 exp/tri1/graph
# utils/mkgraph.sh data/local/lm/fst/train_e_bi_new.arpa exp/tri1 exp/tri1/graph
...
# #utils/mkgraph.sh data/local/lm/fst/train_lm_e_bi.arpa exp/tri2a exp/tri2a/graph
# utils/mkgraph.sh data/local/lm/fst/train_e_bi_new.arpa exp/tri2a exp/tri2a/graph
 # steps/decode.sh --nj 4 --cmd "$decode_cmd" \
...
# #utils/mkgraph.sh data/local/lm/fst/train_lm_e_bi.arpa exp/tri2b exp/tri2b/graph
# utils/mkgraph.sh data/local/lm/fst/train_e_bi_new.arpa exp/tri2b exp/tri2b/graph
# steps/decode.sh --nj 4 --cmd "$decode_cmd" \
...
# # #utils/mkgraph.sh data/local/lm/fst/train_lm_bi.arpa exp/tri3b exp/tri3b/graph
# # utils/mkgraph.sh data/local/lm/fst/train_lm_e_bi.arpa exp/tri3b exp/tri3b/graph
#utils/mkgraph.sh data/local/lm/fst/train_e_bi_new.arpa exp/tri3b exp/tri3b/graph
