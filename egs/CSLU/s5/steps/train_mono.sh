...
if [ $# != 4 ]; then
  echo "Usage: steps/train_mono.sh [options] <data-dir> <lang-dir> <exp-dir> <it_idx>"
...
feats="ark,s,cs:apply-cmvn $cmvn_opts scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- | add-deltas ark:- ark:- |"
...
if [ $stage -le -2 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/compile_graphs.JOB.log \
    ...
    "ark:sym2int.pl --map-oov $oov_sym -f 2- $lang/words.txt < $sdata/JOB/text$4|" \
...
# if [ $stage -le -1 ]; then
  ...
  # $cmd JOB=1:$nj $dir/log/align.0.JOB.log \
    ...
    # gmm-acc-stats-ali --binary=false $dir/0.mdl "$feats" ark:- \
...
# if [ $stage -le 0 ]; then
  # gmm-est --min-gaussian-occupancy=3 --binary=false --mix-up=$numgauss --power=$power \
    # $dir/0.mdl "gmm-sum-accs - $dir/0.*.acc|" $dir/1.mdl 2> $dir/log/update.0.log || exit 1;
  # # rm $dir/0.*.acc
# fi


beam=24 # will change to 10 below after 1st pass
...
ali-to-phones --write-lengths=true $dir/final.mdl "ark:gunzip -c $dir/ali.1.gz|" "ark,t:$dir/phone.tra"
