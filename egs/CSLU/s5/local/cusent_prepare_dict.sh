...
echo 14 > $dir/silence_phones.txt
echo 14 > $dir/optional_silence.txt
# nonsilence phones; on each line is a list of phones that correspond
# really to the same base phone.

# Create the lexicon, which is just an identity mapping
cp ~/CSLU/list/BaseSyl_no_sp.dict $dir/lexicon.txt
cp ~/CSLU/list/IF.list $dir/phones.txt
...
# cp /home/siyuan/kaldi/CSLU/list/bigram.arpa $lm/
cp ~/CSLU/list/count.arpa $lm/
