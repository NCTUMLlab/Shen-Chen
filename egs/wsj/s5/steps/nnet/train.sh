...
if [ ! -z $nnet_init ]; then
  ...
  case "$network_type" in
    ...
    cnn2d) 
      ...
      ;;
    rnn)
      utils/nnet/make_rnn_proto.py $proto_opts \
    ...
    tcn)
      ...
      utils/nnet/make_tcn_proto.py $proto_opts \
        $num_fea $num_tgt 2 'tcn' 40 11 64 16 64 16 'dnn' >$nnet_proto || exit 1
      ;;
     flstm)
       echo "==========flstm initializing==================="
       utils/nnet/make_flstm_proto.py $proto_opts \
         $num_fea $num_tgt 1 'tcn' 40 11 64 16 'dnn' >$nnet_proto || exit 1
      ;;
